...
function Agentsearch () {  
    ...
    useEffect(() => {
        document.body.classList.add('sagentsearch','red','defhider')
        return () => {
          document.body.classList.remove('sagentsearch','red','defhider')
        }
    }, [])
                ...
                <Container fluid className=''>
                    <Row className='row align-items-center justify-content-between'>
                            ...
                            <Offcanvas show={show} onHide={handleClose}>
                                ...
                                <Offcanvas.Body className='pt-4'>
                                    <ListGroup defaultActiveKey="#link1">
                                        <ListGroup.Item action href="#link1">Company</ListGroup.Item>
                        ...
                        <Col className='col-12 col-sm-5 col-md-5 col-lg-8 text-left order-last'>
                            <h4>Organisation Search</h4> 
                            <small className='d-none d-sm-block'>Your last login was on 07 February 2023 at 04:27 PM</small>  
                            <div className='admin-nav'>
                                <Link to='/Superadmin/Sawelcome' title='Dashboard'><i className="fa-solid fa-house"></i></Link>
                        ...
                        <Col className='col-2 col-sm-2 col-md-2 col-lg-1 text-right order-sm-last'>
